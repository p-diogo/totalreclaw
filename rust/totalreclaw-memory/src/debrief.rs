...
mod tests {
    ...
    fn test_format_messages_truncates() {
        ...
        // Should only contain the first message (or none if even that exceeds)
    ...
    fn test_prompt_matches_python_canonical() {
        // Verify the prompt text is identical to the Python implementation's canonical prompt.
        // The Python prompt starts with "You are reviewing..." and ends with "return: []"

    ...
    def system_prompt_block(self) -> str:
        ...
        if self._state.is_configured():
            return (
                ...
                "Memories are end-to-end encrypted, durable, decentralized, "
                ...
                "When describing TotalReclaw to the user, do NOT name the "
                "underlying storage layer — tier and quota only."
            )
        return (

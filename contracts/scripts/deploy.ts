...
/**
 * Deploy EventfulDataEdge and OpenMemoryPaymaster to the target network.
 *
 * Usage:
...
async function main() {
  ...
  console.log("=== OpenMemory Contract Deployment ===");
  ...
  // 2. Deploy OpenMemoryPaymaster
  console.log("Deploying OpenMemoryPaymaster...");

...
import { TotalReclawPaymaster, EventfulDataEdge } from "../typechain-types";

describe("TotalReclawPaymaster", function () {
  let paymaster: TotalReclawPaymaster;
  ...
  describe("Deployment", function () {
    ...
    it("should reject zero address for entryPoint", async function () {
      const Factory = await ethers.getContractFactory("TotalReclawPaymaster");
      await expect(

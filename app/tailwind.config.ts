...
/**
 * "The Keeper" design system — see DESIGN.md / .impeccable/design.json.
 * Warm-white field, one clay accent, soft & tactile surfaces.
 * Ported from the design-validated prototype (branch prototype/spa-look-and-feel)
 * as the functional SPA's design source of truth.
 */
export default {
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Muted status dots for the "what's backed by real engine data" honesty
        // legend — sage / amber / clay. Not brand surface colors.
        emerald: "#5B8A6B",
        amber: "#C89A3C",
      },
      fontFamily: {

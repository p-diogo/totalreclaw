...
- **Packages published (current stables)**: `@totalreclaw/totalreclaw` (OpenClaw plugin) **3.4.4** (npm only — ClawHub retired 2026-07-30; `rc` dist-tag carries 3.4.x-rc.N), `@totalreclaw/mcp-server` **3.4.0** (npm), `@totalreclaw/core` **2.6.0** (npm) / `totalreclaw-core` **2.6.0** (PyPI + crates.io) — all three from one commit, 2026-08-16, `rc` dist-tag at `2.6.0-rc.2`; `totalreclaw` (Python) **2.5.0** (PyPI, 2026-08-16), `@totalreclaw/skill-nanoclaw` **3.0.0** (npm), `@totalreclaw/client` **1.3.0** (npm), `totalreclaw-memory` **2.0.1** (crates.io).

/**
 * TotalReclaw MCP -- Reranker (thin wrapper around `@totalreclaw/core`).
 *
 * As of rc.22 the MCP server no longer ships its own BM25 / RRF / source-weight
 ...
 *
 * Public surface kept for callers (mcp/src/index.ts, mcp/src/consolidation.ts):

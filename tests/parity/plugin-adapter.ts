/**
 * Plugin Adapter for Parity Tests
 *
 * Re-exports the OpenClaw plugin's crypto/LSH/reranker functions for use
 * in parity tests. This adapter exists because the plugin source files
 * (skill/plugin/crypto.ts) use bare import specifiers like
 * '@noble/hashes/argon2' that work under OpenClaw's bundler but not under
 * raw `npx tsx` (which requires '.js' extensions per the package exports map).
 *
 * The functions here are IDENTICAL to those in:
 *   - skill/plugin/crypto.ts
 *   - skill/plugin/lsh.ts
 *   - skill/plugin/reranker.ts
 *
 * INVARIANT: If the plugin source changes, this adapter MUST be updated
 * to match. The parity test will catch any drift between this adapter and
 * the NanoClaw adapter.
 */
...
// =========================================================================
// Crypto (from skill/plugin/crypto.ts)
// =========================================================================
...
// =========================================================================
// LSH Hasher (from skill/plugin/lsh.ts)
// =========================================================================
...
// =========================================================================
// Reranker (from skill/plugin/reranker.ts)
// =========================================================================
